...
const sourceSets: Record<string, SourceLink[]> = {
  ...
  canada: [
    ...
    {
      label: "Government of Canada travel and visas",
...
export const countries: Country[] = [
  ...
  },
  {
    ...
    bestFor: [
      "Digital visa lodgement",
      "Subclass comparison",
      "Student visa financial prep",
      "Employer-sponsored route research",
    ],
    entryOptions: [
      "Visitor visa 600",
      "eVisitor 651",
      "Student visa 500",
      "Temporary Skill Shortage routes",
    ],
    trustNotes: [
  ...
  },
  {
    ...
    bestFor: [
      ...
      "Blocked account prep",
      "University admissions",
      "EU Blue Card research",
    ],
    entryOptions: [
      "Schengen short-stay visas",
      "National D visas",
      "Student residence pathways",
      "Work and EU Blue Card routes",
    ],
    trustNotes: [
  ...
  },
  {
    ...
    bestFor: [
      "Fast digital tourist visas",
      "Business travel planning",
      "Employment entry permit prep",
  ...
  },
  {
    ...
    bestFor: [
      "Fast e-Visa applications",
      "Business visit planning",
      "University admissions",
    ...
    entryOptions: [
      "e-Tourist Visa",
      "e-Business Visa",
      "Sticker visas through missions",
...
export const getCountry = (code: string) => countries.find((c) => c.code === code.toLowerCase());
