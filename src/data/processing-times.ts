...
const notesByCountry: Record<string, string> = {
  ...
  canada:
    "IRCC publishes rolling processing estimates by country of residence rather than destination alone.",
  uk: "Priority and Super Priority services can reduce post-biometric review time where offered.",
  australia:
    "Complex subclass reviews and health or character checks often push files beyond service standards.",
  germany:
    "Short-stay approvals may be quick, but appointment backlogs can add weeks before submission.",
  uae: "Tourist e-visas are typically digital and fast; sponsor-backed work and residency routes take longer.",
  india:
    "e-Visa decisions are often fast, but sticker visa and long-stay routes require deeper manual review.",
};
